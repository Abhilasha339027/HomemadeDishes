...
export default function AdminNavbar() {
  ...
  const handleUIChange = () => {
    let currentTheme = JSON.parse(localStorage.getItem("isDark"));
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          <Box ml="auto">
            <IconButton onClick={handleUIChange} color="inherit">
      ...
      >
        ...
        <List>
          ...
          <ListItem
            button
            onClick={() => history.push(`/admin-dashboard/dishes`)}
          >
            <ListItemIcon>
          ...
          <ListItem
            button
            onClick={() => history.push(`/admin-dashboard/settings`)}
          >
            <ListItemIcon>
